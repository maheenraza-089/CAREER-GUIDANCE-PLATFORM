...
def _builtin_institutes():
    """Fallback institute data when CSV and web scraping both fail."""
    rows = [
        {"name": "FAST-NUCES", "city": "Karachi", "country": "Pakistan", "type": "University",
         "career_field": "Computer Science, AI, Data Science, Software Engineering",
         "academic_level": "Undergraduate", "fee_min": 3000, "fee_max": 6000, "ranking": 9, "scholarship": True,
         "website": "nu.edu.pk"},
        {"name": "NED University", "city": "Karachi", "country": "Pakistan", "type": "University",
         "career_field": "Civil Engineering, Electrical Engineering, Mechanical Engineering",
         "academic_level": "Undergraduate", "fee_min": 1000, "fee_max": 3000, "ranking": 8, "scholarship": True,
         "website": "neduet.edu.pk"},
        {"name": "IBA Karachi", "city": "Karachi", "country": "Pakistan", "type": "University",
         "career_field": "Business, Finance, Marketing, Entrepreneurship",
         "academic_level": "Undergraduate", "fee_min": 4000, "fee_max": 8000, "ranking": 9, "scholarship": True,
         "website": "iba.edu.pk"},
        {"name": "Aga Khan University", "city": "Karachi", "country": "Pakistan", "type": "University",
         "career_field": "Medicine, Nursing, Healthcare, Pharmacy",
         "academic_level": "Graduate", "fee_min": 5000, "fee_max": 12000, "ranking": 10, "scholarship": True,
         "website": "aku.edu"},
        {"name": "COMSATS University", "city": "Islamabad", "country": "Pakistan", "type": "University",
         "career_field": "Computer Science, Engineering, Data Science",
         "academic_level": "Undergraduate", "fee_min": 2500, "fee_max": 5000, "ranking": 8, "scholarship": True,
         "website": "comsats.edu.pk"},
        {"name": "LUMS", "city": "Lahore", "country": "Pakistan", "type": "University",
         "career_field": "Business, Law, Computer Science, Economics",
         "academic_level": "Undergraduate", "fee_min": 8000, "fee_max": 15000, "ranking": 10, "scholarship": True,
         "website": "lums.edu.pk"},
        {"name": "UET Lahore", "city": "Lahore", "country": "Pakistan", "type": "University",
         "career_field": "Electrical Engineering, Mechanical Engineering, Civil Engineering",
         "academic_level": "Undergraduate", "fee_min": 1500, "fee_max": 4000, "ranking": 9, "scholarship": True,
         "website": "uet.edu.pk"},
        {"name": "Coursera", "city": "Online", "country": "Global", "type": "Online Platform",
         "career_field": "AI, Data Science, Software Engineering, Business, Marketing",
         "academic_level": "Online / Bootcamp", "fee_min": 0, "fee_max": 500, "ranking": 9, "scholarship": True,
         "website": "coursera.org"},
        {"name": "edX", "city": "Online", "country": "Global", "type": "Online Platform",
         "career_field": "Computer Science, Data Science, Business, Engineering",
         "academic_level": "Online / Bootcamp", "fee_min": 0, "fee_max": 300, "ranking": 9, "scholarship": True,
         "website": "edx.org"},
        {"name": "MIT OpenCourseWare", "city": "Online", "country": "Global", "type": "Online Platform",
         "career_field": "Engineering, Physics, Mathematics, Computer Science",
         "academic_level": "Online / Bootcamp", "fee_min": 0, "fee_max": 0, "ranking": 10, "scholarship": True,
         "website": "ocw.mit.edu"},
    ]
...
def do_train(df, n_aug=600):
    ...
    # Guard: need at least 5 samples to split
    if len(Xs) < 5:
        ...
        return {"model": rf, "scaler": sc, "accuracy": None, "cv_mean": None, "cv_std": None,
                "fi": dict(zip(FEATURE_COLS, rf.feature_importances_)), "n_samples": len(Xs)}
    n_samples = len(Xs)
    test_sz = max(0.1, min(0.2, 1 / n_samples * max(1, int(n_samples * 0.2))))
...
def ml_predict(profile, df, top_n=5):
    # Always use full career dataset for model training (not filtered df)
    r = get_model("career_rf_model")
